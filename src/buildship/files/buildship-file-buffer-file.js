...
exports.BuildShipFileBufferFile = void 0;
var fs_1 = require("fs");
...
var BuildShipFileBufferFile = /** @class */ (function () {
    function BuildShipFileBufferFile(workflowExecutionId, buffer, meta) {
        this.type = "file-buffer";
    ...
    BuildShipFileBufferFile.prototype.convertTo = function (desiredType) {
        var _this = this;
        switch (desiredType) {
            case "file-buffer":
            ...
            case "base64":
                return function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, new buildship_base64_file_js_1.BuildShipBase64File(this._workflowExecutionId, this.file.toString("base64"), this.metadata)];
                    });
                }); };
            default:
    ...
    BuildShipFileBufferFile.prototype.saveAsLocalFile = function (destinationPath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fs_1.promises.writeFile(pathToUse, this.file)];
                    case 2:
                        _a.sent();
    ...
    return BuildShipFileBufferFile;
}());
exports.BuildShipFileBufferFile = BuildShipFileBufferFile;
